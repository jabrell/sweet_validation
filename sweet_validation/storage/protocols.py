...
class StorageProtocol(Protocol):
    ...
    def save(key: Any, value: Any, **kwargs: Any) -> None: ...
    def load(key: Any, **kwargs: Any) -> Any: ...
    def delete(key: Any, **kwargs: Any) -> Any: ...
    def exists(key: Any, **kwargs: Any) -> bool: ...
    def list(self) -> list[Any]: ...
    def replace(key: Any, value: Any, **kwargs: Any) -> Any: ...
